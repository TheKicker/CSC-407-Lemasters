...
class MovieTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Movie::create(array(
            ...
            'genreID' => 6,
            'coverPhoto' => 'Shawshank_Redemption.jpg',
            'isDISC' => rand(1,1),
            'isBLURAY' => rand(0,1),
        ));
        ...
        Movie::create(array(
            ...
            'genreID' => 1,
            'coverPhoto' => 'The_Great_Gatsby.jpg',
            'isDISC' => rand(0,1),
            'isBLURAY' => rand(1,1),
        ));
